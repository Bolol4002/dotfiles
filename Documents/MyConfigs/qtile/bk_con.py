...
#pywal stuff
def load_colors(cache_path='/home/sayooj/.cache/wal/colors'):
    global colors
    try:
        with open(cache_path, 'r') as file:
            for _ in range(8):
                colors.append(file.readline().strip())
        colors.append('#ffffff')  # extra color if needed
    except:
        # fallback colors (Gruvbox Dark)
        colors.extend(["#1d2021", "#cc241d", "#98971a", "#d79921",
                       "#458588", "#b16286", "#689d6a", "#a89984", "#ffffff"])
